...
//            "INSERT INTO song VALUES (?,?,?,?,?,?)"};
    ...
    public List<Song> findAllSongsOfUser(String userName) {
        ...
        try {
            ...
            LOGGER.error("Error while selecting all songs of user username =  " + userName + " ", e);
            e.printStackTrace();
        } finally {
            closePrepareStatement(preparedStatement);
            closeResultSet(resultSet);
    ...
    public List<Song> findAllSongsOfPlaylist(String playlistName) {
        List<Song> songs = new ArrayList<>();
        try {
            preparedStatement = getPrepareStatement(SELECT_ALL_SONGS_FROM_PLAYLIST);
            ...
            LOGGER.error("Error while selecting all songs from playlist name = " + playlistName + " ", e);
            e.printStackTrace();
        } finally {
            closePrepareStatement(preparedStatement);
            closeResultSet(resultSet);
